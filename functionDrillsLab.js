...
//CODE HERE
function theEliminator(cont1, loser){
...
function upperString(someString){
...
console.log(emailCheck("  carlotta123@gmail.com "));
console.log(emailCheck(" carlotta23gmail.com"));
...
function buyFrogs(gold){
	let boughtFrogs = gold / 3;
	return Math.floor(boughtFrogs);
	//console.log(Math.floor(boughtFrogs));	
}
...
let totalFrogs2 = buyFrogs(1);
console.log(totalFrogs2);
totalFrogs2 = buyFrogs(6);
console.log(totalFrogs2);
totalFrogs2 = buyFrogs(2);
console.log(totalFrogs2);

////////////////// PROBLEM 15 ////////////////////
let sampleArray = [0,1,2,3,4,7,5,6,8,9];
let sampleTrue = [0, 1, 2, 3];
/*
...
function ascOrder(array){
	for(let i = 0; i < array.length; i++){
		if(array[i] > array[i+1])
			return false; //check for false first
	}
	return true; //if entire array in order, return true
}
let arrayIsAscending = ascOrder(sampleArray);
console.log(arrayIsAscending);
arrayIsAscending = ascOrder(sampleTrue);
console.log(arrayIsAscending);
